...
songplay_table_create = ("""
    ...
    (songplay_id SERIAL PRIMARY KEY, start_time text, user_id text, 
...
song_table_create = ("""
    ...
    (song_id text, title text, artist_id text, year int, duration int)
""")

# artist_id, name, location, latitude, longitude
artist_table_create = ("""
    CREATE TABLE IF NOT EXISTS artists 
    (artist_id text, name text, year text, location text, latitude int, longitude int)
""")

# start_time, hour, day, week, month, year, weekday
time_table_create = ("""
    CREATE TABLE IF NOT EXISTS time 
    (start_time text, hour text, day text, week text, month text, year text, weekday text)
""")
